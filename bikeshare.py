    ...
    while True:
        ...
        try:
            if input_read in ['chicago','new york city','washington'] and input_type == 1:
                ...
                if input_type == 1:
                    print(" Wrong input! your input should be: chicago new york city or washington")
                if input_type == 2:
                    print(" Wrong input! your input should be: january, february, march, april, may, june or all")
                if input_type == 3:
                    print(" Wrong input! your input should be: sunday, ... friday, saturday or all")
        except ValueError:
...
def get_filters():
    ...
    """
    print('Hi! My name is Ahmed. I will helb you to explore some US bikeshare data.')
